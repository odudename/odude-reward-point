...
class ODude_Reward_Point_API_Client {

	private $api_url;
	private $secret_key;

	public function __construct() {
		$this->api_url    = rtrim( get_option( 'odude_reward_point_api_url', 'https://point.odude.com/api/v1' ), '/' );
		$this->secret_key = get_option( 'odude_reward_point_secret_key', '' );
	}
